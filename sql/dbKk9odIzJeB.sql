...
--
-- Host: localhost
-- Generation Time: Mar 13, 2026 at 03:31 AM
...
(1, 'artist', 'SilverSpire_Ink', 'Naomi', 'Sinclair', 'naomi.sinclair@gmail.com', 'naomi', 'images/profilephotos/Artist/Profile_1.jpg', '2026-03-05 05:05:09', '2026-03-12 18:18:29'),
(3, 'admin', 'test', 'test', 'test', 'test@gmail.coom', 'test', '', '2026-03-05 05:23:30', '2026-03-05 05:23:30'),
(6, 'user', 'alex_client', 'Alex', 'Carter', 'alex_client@inkseek.test', 'Alex', 'images/profilephotos/User/UP_5.jpg', '2026-03-11 20:12:52', '2026-03-12 18:03:28'),
(7, 'artist', 'marco_black', 'Marco', 'Alvarez', 'marco_black@inkseek.test', 'Marco', 'images/profilephotos/Artist/pROFILE_3.jpg', '2026-03-11 20:13:59', '2026-03-12 18:18:20'),
(8, 'artist', 'emily_lines', 'Emily', 'Shaw', 'emily_lines@inkseek.test', 'Emily', 'images/profilephotos/Artist/Profile_4.jpg', '2026-03-11 20:53:52', '2026-03-12 18:00:33'),
(9, 'artist', 'jordan_inkj', 'Jordan', 'Patel', 'jordan_inkj@inkseek.test', 'Jordan', 'images/profilephotos/Artist/Profile_2.jpg', '2026-03-11 20:57:13', '2026-03-12 18:00:01'),
(10, 'artist', 'luis_realism', 'Luis', 'Ramirez', 'luis_realism@inkseek.test', 'Luis', 'images/profilephotos/Artist/Profile_5.jpg', '2026-03-11 20:58:34', '2026-03-12 18:00:58'),
(11, 'user', 'nina_client', 'Nina', 'Lopez', 'nina_client@inkseek.test', 'Nina', 'images/profilephotos/User/UP_1.jpg', '2026-03-11 20:59:17', '2026-03-12 18:04:05'),
(12, 'user', 'david_client', 'David', 'Brooks', 'david_client@inkseek.test', 'David', 'images/profilephotos/User/UP_3.jpg', '2026-03-11 20:59:51', '2026-03-12 18:04:34'),
(13, 'user', 'sophia_client', 'Sophia', 'Martinez', 'sophia_client@inkseek.test', 'Sophia', 'images/profilephotos/User/UP_2.jpg', '2026-03-11 21:00:28', '2026-03-12 18:04:50'),
(14, 'user', 'thewanderingquill', 'Mayson', 'Quill', 'mayquill225@inkseektest.com', 'Mayson', 'images/profilephotos/User/UP_4.jpg', '2026-03-11 21:09:00', '2026-03-12 18:02:57');
...
DROP TABLE IF EXISTS `artist_style_tag`;
...
INSERT INTO `bookmarks` (`account_id`, `tattoo_id`, `created_at`) VALUES
(14, 14, '2026-03-13 01:42:12'),
(14, 88, '2026-03-13 00:10:14'),
(14, 94, '2026-03-13 00:10:07');
...
(1, 1, '3784 Howell Branch Rd', 'Winter Park', 'Florida', '32792', '2026-03-05 05:41:23', '2026-03-12 22:30:29'),
...
INSERT INTO `messages` (`message_id`, `sender_id`, `recipient_id`, `message_body`, `created_at`) VALUES
(1, 1, 14, 'whatup', '2026-03-13 01:36:58'),
(2, 14, 1, 'yooo', '2026-03-13 01:42:21');
...
INSERT INTO `reviews` (`review_id`, `reviewer_id`, `artist_id`, `title`, `content`, `rating`, `created_at`, `updated_at`) VALUES
(1, 14, 1, 'Artist Review', 'Such impressive artwork', 5, '2026-03-13 02:26:51', '2026-03-13 02:33:19');
...
(12, 1, 'images/tattoos/styles/Anime/Anime_eyes.jpg', 'Anime Eyes', 'Two manga-style eye panels with sharp linework and contrasting red and blue highlights.', '2:3', '2026-03-11 21:04:41', '2026-03-12 21:59:14'),
(13, 1, 'images/tattoos/styles/Anime/Anime_fineline.jpg', 'Anime Fineline', 'Fine line anime portrait with a surreal double-face illusion and delicate shading.', '2:3', '2026-03-11 21:07:16', '2026-03-12 21:59:14'),
(14, 1, 'images/tattoos/styles/Anime/Anime_girl.jpg', 'Anime Girl', 'Bright anime character tattoo with vibrant colors and expressive manga-style features.', '2:3', '2026-03-11 21:07:26', '2026-03-12 21:59:14'),
...
(42, 1, 'images/tattoos/styles/Illustrative/illustrative_1.jpg', 'Illustrative Landscape', 'Illustrative blackwork tattoo showing a floating landscape scene with detailed line shading.', '2:3', '2026-03-11 21:59:59', '2026-03-12 21:59:14'),
...
(44, 1, 'images/tattoos/styles/Illustrative/illustrative_3.jpg', 'Illustrative Bird and Fruit', 'High-contrast illustrative tattoo of a bird perched on fruit with sharp line detail.', '2:3', '2026-03-11 22:00:19', '2026-03-12 21:59:14'),
...
(47, 1, 'images/tattoos/styles/Japanese/japanese_3.jpg', 'Japanese Oni Sleeve', 'Japanese sleeve featuring an oni mask, flowers, and dark wave-like background.', '2:3', '2026-03-11 22:00:50', '2026-03-12 21:59:14'),
(48, 1, 'images/tattoos/styles/Japanese/japanese_4.jpg', 'Japanese Floral Sleeve', 'Full Japanese sleeve with black background, bright flowers, and wave elements.', '2:3', '2026-03-11 22:00:59', '2026-03-12 21:59:14'),
(49, 1, 'images/tattoos/styles/Japanese/japanese_5.jpg', 'Japanese Chest Panels', 'Japanese chest tattoo with dragon and mask imagery in a lighter traditional style.', '2:3', '2026-03-11 22:01:08', '2026-03-12 21:59:14'),
...
DROP TABLE IF EXISTS `tattoo_style_tag`;
...
ALTER TABLE `messages`
  ...
  ADD KEY `idx_messages_sender_recipient` (`sender_id`,`recipient_id`,`created_at`),
  ADD KEY `idx_messages_recipient_sender` (`recipient_id`,`sender_id`,`created_at`);
...
--
ALTER TABLE `style_tags`
  MODIFY `tag_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `tattoos`
--
ALTER TABLE `tattoos`
  MODIFY `tattoo_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `fk_messages_recipient` FOREIGN KEY (`recipient_id`) REFERENCES `accounts` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_messages_sender` FOREIGN KEY (`sender_id`) REFERENCES `accounts` (`account_id`) ON DELETE CASCADE ON UPDATE CASCADE;
