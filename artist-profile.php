...
<body>
    ...
    <div id="artist-profile-container">
        ...
        <div id="artist-sidebar">
            <div id="artist-info">
                <h2 id="artist-name">@SilverSpire_Ink</h2>
                <p style="font-family: 'Zain', sans-serif; font-size: 16px; margin: 5px 0 0 0; color: #666;">Naomi
                    Sinclair</p>
                <div id="rating">
                    <div id="stars">
                    ...
                    <p id="review-count">128 reviews</p>
                </div>

                <div id="artist-layout">
                    <div id="artist-picture">
                        <img src="images/profile photos/Artist/Profile_1.jpg" alt="Artist Profile Picture">
                    </div>

                    <div id="artist-details">
                        <div class="detail-item">
                            <h4>Location</h4>
                            <p><span class="tag">Winter Park, FL</span></p>
                        </div>
                        <div class="detail-item rates-group">
                            <h4>Hourly Rate</h4>
                            <p><span class="tag">$150</span></p>
                            <h4>Minimum</h4>
                            <p><span class="tag">$150</span></p>
                            <h4>Day Rate</h4>
                            <p><span class="tag">$1000</span></p>
                        </div>
                        <div class="detail-item">
                            <h4>Style</h4>
                            <p><span class="tag">Japanese</span><br><span class="tag">Anime</span><br><span
                                    class="tag">Illustrative</span></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="info-section">
                ...
                <div class="section-content">
                    <p>Hi my name is Naomi! I specialize in realistic and bold illustrative tattoos. I love
                        collaborating
                        with clients to bring their ideas to life, creating pieces that feel personal and timeless. With
                        a background in both digital and traditional art, I focus on Japanese-inspired designs and anime
                        aesthetics, blending classic Irezumi elements with contemporary illustration techniques. Each
                        piece I create honors the rich traditions of Japanese tattooing while incorporating modern
                        storytelling.</p>
                </div>
            </div>
